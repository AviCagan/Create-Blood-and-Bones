...
public final class SocialEffects {
    ...
    public static void lang() {
        ...
        BBLang.trait("piglin_kin", "Piglin Kin",
                "Piglins and their brutes take you for one of their own, as if you wore gold. One you hurt fights back for 30 seconds.");
        BBLang.trait("ender_calm", "Ender Calm",
                "Endermen take no notice of the minion. One it hurts fights back for 30 seconds.");
